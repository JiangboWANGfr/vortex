...
`ifdef PLATFORM_MERGED_MEMORY_INTERFACE
    parameter C_MEM_NUM_BANKS       = 1,
`else
    parameter C_MEM_NUM_BANKS       = `PLATFORM_MEMORY_NUM_BANKS,
`endif
    parameter C_MEM_DATA_WIDTH      = `PLATFORM_MEMORY_DATA_SIZE * 8,
    parameter C_MEM_ADDR_WIDTH      = `PLATFORM_MEMORY_ADDR_WIDTH - `CLOG2(C_MEM_NUM_BANKS),
