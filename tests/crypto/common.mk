# NOTE: resolved against make's CWD, i.e. the test directory
# tests/crypto/<family>/<test>/ -- one level deeper than tests/regression/.
ROOT_DIR := $(realpath ../../../..)
...
# a crypto instruction whose PE is absent falls through VX_decode's default arm
